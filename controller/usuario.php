...
/**
 * Função responsável por realizar os passos em comum entre as funções de editar o usuáriio
 ...
 */
function atualizar($usuario, $msg) {
    $_SESSION['resultado'] = [];
    try {
...
/**
 * Função responsável por atualizar a foto de um usuário
 */
function atualizarFoto() {
    $usuario = unserialize($_SESSION['usuario']);
    $fotoAntiga = $usuario->getFoto();
    $usuario->setFoto(carregarFoto());
    atualizar($usuario, "Foto alterada com sucesso!");
...
/**
 * Função responsável por atualizar os dados básicos do usuário
 */
function atualizarDados() {
    ...
    atualizar($usuario, "Dados alterados com sucesso!");
    header("Location: ../view/editar-dados.php");
}
...
function atualizarSenha() {
    ...
    atualizar($usuario, "Senha alterada com sucesso!");
    header("Location: ../view/editar-dados.php");
}
